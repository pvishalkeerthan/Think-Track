  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {userStats && (
          <div className={`bg-gradient-to-r ${getRankColor(rank)} rounded-xl shadow-lg p-6 mb-8 text-white`}>
            <div className="text-center">
              ...
              <div className="grid grid-cols-3 gap-4 max-w-md mx-auto">
                ...
                <div className="bg-white/20 rounded-lg p-3">
                  <div className="text-2xl font-bold">{userStats.totalTime || '0'}s</div>
                    ...
                    >
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <span className="text-2xl mr-2">{getRankEmoji(position)}</span>
                        ...
                        <div className="flex items-center">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center mr-3 ${
                            ...
                            <span className={`font-semibold ${
                              isCurrentUser ? 'text-green-700' : 'text-gray-600'
                            }`}>
